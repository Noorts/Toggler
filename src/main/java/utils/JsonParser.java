...
public class JsonParser {
     ...
     * adhere to the toggles JSON format. See the defaultToggles defined in the
     * AppSettingsState class for more information about the format.
     * @param jsonText that contains the toggles in the JSON format defined by
     * this plugin.
     * @throws TogglesFormatException when the toggles in the provided String
     * are malformed.
     */
    ...
    /**
     * Parse JSON-formatted text to the toggles data structure defined by this
     * plugin.
     * @param jsonText that contains the toggles in the JSON format defined by
     *                 this plugin. See the defaultToggles defined in the
     *                 AppSettingsState class for more information about the
     *                 format.
    ...
    public static List<List<String>> parseJsonToToggles(String jsonText) throws TogglesFormatException {
        ...
        for (String toggle : toggles) {
            ...
            for (String word : words) {
                ...
                // Throw an error if the word contains any forbidden boundary
                // characters.
        ...
        /* Will check if the togglesStructure contains any duplicate
           words/symbols. An error will be thrown if a duplicate is found. */
     ...
     * @param togglesStructure the toggles in the plugin's toggles data
     * structure.
    ...
    /**
     * Check if the provided toggles contain any duplicate words/symbols. I.e.
     * if a duplicate word/symbol is found in two different toggles or if a
     * duplicate is found inside the same toggle.
    ...
    /**
     * Check if the provided word contains a boundary character. The boundary
     * characters are used in the toggle action to detect a word/symbol by
     * expanding the selection from a caret.
     * @param word the word/symbol to be checked.
     * @throws TogglesFormatException when a word/symbol was found that contains
